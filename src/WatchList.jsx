...
import {Box, IconButton, List, Alert } from '@mui/material';
            ...
            <Table sx={{ mixWidth: 200 }} aria-label="customized table">
              ...
              {watchlist?.map((stock,i) => (
                  <StyledTableRow key={i}>
                    ...
                    <StyledTableCell >{stock['2. name']}</StyledTableCell>
                    <StyledTableCell >{stock['1. symbol']}</StyledTableCell>
                    <StyledTableCell >{stock?.price}</StyledTableCell>
                    <StyledTableCell ><DeleteIcon sx={{ cursor: 'pointer' }} onClick={() => removeFromWatchlist(i)} /></StyledTableCell>
                  </StyledTableRow>
                ))}
              </TableBody>
            </Table>
